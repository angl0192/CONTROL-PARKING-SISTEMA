                            ...
                            <div class="card">
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-sm-5">
                                            <div class="text-sm-end">
                                                ...
                                                data-bs-target="#bs-example-modal-xl" data-remote="reg-servicios.php" data-sb-backdrop="static" data-sb-keyboard="false">
                                ...
                                <div class="card-body">
                                    <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        ...
                                        <tbody>
                                            <?php
                                                $sqlConsulta = mysqli_query($conexion, "SELECT * FROM servicios");
                                                while($fcons = mysqli_fetch_array($sqlConsulta)){
                                                    $cod_servicio = $fcons['cod_servicio'];
                                                    $nombre_servicio = $fcons['nombre_servicio'];
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    data-bs-target="#bs-example-modal-xl" data-remote="mod-servicios.php?cod_servicio=<?=$cod_servicio?>" 
                                                    data-sb-backdrop="static" data-sb-keyboard="false">
                                                        <i class="uil uil-edit-alt"></i>
                                                    </a>
                                                    <a href="#" class="btn btn-danger borrarReg">
                                                        <i class="mdi mdi-delete"></i>
                                                        <input type="hidden" class="codborrar" name="codborrar" value="<?=$cod_servicio?>">
                                                    </a>
                                                </td>
                                            </tr> 
                                            <?php
        ...
        <div class="modal-dialog modal-xl modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="myExtraLargeModalLabel">Insertar/Editar Servicios</h5>
    ...
    <script>
        $(function(){
            ...
            $(document).on('click', '.borrarReg', function(){
                var cod_servicio = $('.codborrar', this).val();
                var datosEnviar = {
