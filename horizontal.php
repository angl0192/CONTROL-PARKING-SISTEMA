...
<!-- Mirrored from themesdesign.in/vuesy/layouts/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 23 Jun 2022 15:59:26 GMT -->
<head>
                            ...
                            <div class="collapse navbar-collapse" id="topnav-menu-content">
                                <ul class="navbar-nav">
                                    ...
                                    <li class="nav-item dropdown">
                                        <div class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-pages" role="button">
                                    ...
                                    <li class="nav-item dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="topnav-pages">
                                            <div class="menu-title">Parqueo</div>
                                    ...
                                    <li class="nav-item dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="topnav-pages">
                                            ...
                                            <a href="apps-kanban-board.html" class="dropdown-item" data-key="t-kanban">Lista Ventas</a>
                                    ...
                                    <li class="nav-item dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="topnav-pages">
                                            ...
                                            <a href="apps-kanban-board.html" class="dropdown-item" data-key="t-kanban">Reporte de Ventas SUNAT</a>
                                    ...
                                    <li class="nav-item dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="topnav-pages">
                                            ...
                                            <a href="apps-calendar.html" class="dropdown-item" data-key="t-calendar">Servicios</a>                                            
                                        </div>
                                    </li>
        
                                    <li class="nav-item dropdown">
                                        <div class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-uielement" role="button"
                                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-4-5">
                                                        <div>
                                                            ...
                                                            <div>
                                                                <a href="ui-alerts.html" class="dropdown-item" data-key="t-alerts">Exportar Base de Datos</a>
                                                            </div>                                                            
                                                        </div>
                                                    </div>
                                                </div>
