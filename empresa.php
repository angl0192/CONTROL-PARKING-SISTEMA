...
<html lang="es">
    ...
    <script>
        ...
        var imgApp = new Dropzone("#imgApp", {
            ...
            dictRemoveFile: "Borrar",
            dictMaxFilesExceeded: "Solo {{maxFiles}} archivos están permitidos",
            dictDefaultMessage: "Arrastra la imagen jpg/png de 922x270px aquí"
        });
        ...
        var imgMov = new Dropzone("#imgMov", {
            ...
            dictRemoveFile: "Borrar",
            dictMaxFilesExceeded: "Solo {{maxFiles}} archivos están permitidos",
            dictDefaultMessage: "Arrastra la imagen jpg/png de 190x190px aquí"
        });
        ...
        /**********************************************************************/
        <?php
        $sqlImagen                  = mysqli_query($conexion, "SELECT certificado FROM empresa WHERE id_empresa='$id_empresa'");
        $numImg                     = mysqli_num_rows($sqlImagen);
        if ($numImg > 0 and $certificado != '') {
        ?>
            var images = [
                <?php
                while ($fimg        = mysqli_fetch_array($sqlImagen)) {
                    ...
                    $obj["name"]    = $imagen;
                    $obj["size"]    = filesize("img-apps/certificado/" . $imagen);
                    echo "
                        {
                        name: '" . $obj["name"] . "',
                        url: 'img-apps/certificado/" . $obj["name"] . "',
                        size: '" . $obj["size"] . "'
                        },";
                }
                ?>
