...
<head>
                                    ...
                                    <div class="row mb-2">
                                        <div class="col-sm-12">
                                            <div class="text-sm-end">
                                                ...
                                                data-bs-target="#bs-example-modal-xl" data-remote="formulario-modal.html" data-sb-backdrop="static" data-sb-keyboard="false">
    ...
    <!-- ****************************************************************** -->
    <!-- <div class="modal fade bs-example-modal-xl" id="bs-example-modal-xl" data-bs-backdrop="static" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true" style="overflow:hidden;"> 
        
    <div class="modal fade bs-example-modal-xl" id="bs-example-modal-xl" tabindex="-1" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
    -->
