        ...
        <div class="row">
                <div class="card-body">
                    <div class="col-xl-12">
                        ...
                        <div class="mb-3 row">
                            <label for="choices-single-groups" class="col-md-2 col-form-label">Ciudades</label>
                            <div class="col-md-10">
                                <select class="form-control select2" name="choices-single-groups" id="choices-single-groups">
