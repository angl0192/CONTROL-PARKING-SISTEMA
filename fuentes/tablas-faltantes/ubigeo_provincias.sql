...
-- Tiempo de generación: 09-04-2023 a las 17:25:19
...
CREATE TABLE `ubigeo_provincias` (
  ...
  `department_id` varchar(2) COLLATE utf8mb4_unicode_ci NOT NULL
...
INSERT INTO `ubigeo_provincias` (`id`, `name`, `department_id`) VALUES
('0101', 'Chachapoyas', '01'),
('0102', 'Bagua', '01'),
('0103', 'Bongará', '01'),
