                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <h4 class="mb-0">Todotec Perú</h4>
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">Todotec Perú</a></li>
        ...
        <div class="vertical-menu">
            <div class="navbar-brand-box">
                <a href="index.html" class="logo logo-dark">
                    ...
                    <span class="logo-lg">
                        <img src="assets/images/logo-sm.svg" alt="" height="26"> <span class="logo-txt">Todotec Peru</span>
                    </span>
                </a>
                <!--  -->
                <a href="index.html" class="logo logo-light">
                    ...
                    <ul class="metismenu list-unstyled" id="side-menu">
                        ...
                        <li>
                            <a href="dashboard.html">
                                ...
                                <span class="menu-item" data-key="t-dashboard">Escritorio</span>
                        ...
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                                <li><a href="empresa.html" data-key="t-empresa">Datos de Empresa</a></li>
                                <li><a href="#" data-key="t-product-detail">Tiendas/Locales</a></li>
                                <li><a href="personal.html" data-key="t-personal">Personal</a></li>
                                <li><a href="#" data-key="t-customers">Clientes</a></li>
                            </ul>
                        </li>
                        <li>
                            <a href="javascript: void(0);" class="has-arrow">
                                <i class="bx bx-mail-send nav-icon"></i>
                                <span class="menu-item" data-key="t-email">Ventas</span>
                            </a>
                            <ul class="sub-menu" aria-expanded="false">
                                <li><a href="#" data-key="t-inbox">Apetura Cajas</a></li>
                                <li><a href="#" data-key="t-read-email">Gastos Diarios</a></li>
                            </ul>
                        </li>
                        <li>
                            <a href="javascript: void(0);" class="has-arrow">
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                                <li><a href="#" data-key="t-user-grid">Facturas Electronicas</a></li>
                                <li><a href="#" data-key="t-user-list">Boletas Electronicas</a></li>
                                <li><a href="#" data-key="t-user-settings">Resumen de Boletas</a></li>
                            </ul>
                        </li>
                        <li>
                            <a href="javascript: void(0);" class="has-arrow">
                                <i class="bx bx-briefcase-alt-2 nav-icon"></i>
                                <span class="menu-item" data-key="t-projects">Almacen</span>
                            </a>
                            <ul class="sub-menu" aria-expanded="false">
                                <li><a href="#" data-key="t-p-grid">Categoría</a></li>
                                <li><a href="#" data-key="t-p-list">Sub Categoría</a></li>
                                <li><a href="#" data-key="t-p-overview">Marcas</a></li>
                                <li><a href="#" data-key="t-create-new">Productos</a></li>
                                <li><a href="#" data-key="t-salida">Salida</a></li>
                                <li><a href="#" data-key="t-trapaso">Traspaso</a></li>
                                <li><a href="#" data-key="t-devoluciones">Devoluciones</a></li>
                            </ul>
                        </li>
                        <li>
                            <a href="index.html">
                                <i class="bx bx-home-circle nav-icon"></i>
                                <span class="menu-item" data-key="t-dashboard">Salir</span>
                            </a>
                        </li>
                    </ul>
                </div><!-- Sidebar -->
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            </script> &copy; Todotec Peru.
                        </div>
                        <div class="col-sm-6">
                            <div class="text-sm-end d-none d-sm-block">
                                Desarrollado <i class="mdi mdi-heart text-danger"></i> por <a href="https://abelespinoza.com.com/" target="_blank" class="text-reset">Abel Espinoza H.</a>
                            </div>
                        </div>
                    </div>
                </div>
