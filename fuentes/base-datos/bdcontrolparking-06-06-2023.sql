...
-- Tiempo de generación: 06-06-2023 a las 10:10:17
...
--
-- Base de datos: `ejstorec_bdcontrolparking`
--
...
CREATE TABLE `accesos_usuarios` (
  ...
  `cod_submodulos` int(11) DEFAULT NULL,
...
CREATE TABLE `apertura_cajas` (
  `cod_aperturacaja` int(11) NOT NULL,
  `turno` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `fecha_creacion` date DEFAULT NULL,
  `fecha_cierre` date DEFAULT NULL,
  `nombre_caja` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cod_personal` int(11) DEFAULT NULL,
...
CREATE TABLE `clientes` (
  ...
  `estado` char(1) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'A=Activo/I=Inactivo'
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `clientes` (`cod_cliente`, `fecha_creacion`, `fecha_actualizacion`, `cod_personal`, `nombres`, `cod_tipodoc`, `num_documento`, `direccion`, `movil`, `email`, `estado`) VALUES
(1, NULL, '2023-06-01 02:51:08', 1, 'ASOCIADOS JYM SAC', 3, '20609335468', 'Horacio Zevallos Mz C Lt 5 Grp L Ate Virtarte Lima', '933141532', 'ASOCIADOS.JYM.PERU@gmail.com', 'A');
...
CREATE TABLE `detalle_factura` (
  ...
  `incluye_igv` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `igv_unit` double DEFAULT NULL,
  `igv_total` double DEFAULT NULL,
...
CREATE TABLE `empresa` (
  ...
  `icono_web` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `logo_app` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `logo_movil` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `logo_documentos` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `direccion` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `codigoUbigeo` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `codigoLocal` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `telefono` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `movil` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `email` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `tipo` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '1=Produccion/3=Prueba',
  ...
  `certificado` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `empresa` (`id_empresa`, `ruc`, `razon_social`, `nombre_comercial`, `icono_web`, `logo_app`, `logo_movil`, `logo_documentos`, `direccion`, `Departamento`, `Provincia`, `Distrito`, `codigoUbigeo`, `codigoLocal`, `telefono`, `movil`, `email`, `tipo`, `usuario_sol`, `clave_sol`, `certificado`, `clave_certificado`, `clave_borrar`) VALUES
(1, '20521356309', 'CONTROL PARKING S.A.C.', 'CONTROL PARKING', 'favicon.ico', 'logo-color-light.png', 'icono2.png', 'logo-color-light.png', 'AV. PRIMAVERA NRO. 607 INT. 205 URB. CHACARILLA', '15', '1501', '150130', '652475', '0000', '(01) 4800282', '958825129', 'info@controlparking.com.pe', '3', 'MODDATOS', 'moddatos', '', '210610', '210610');
...
CREATE TABLE `estacionamientos` (
  `cod_estacionamiento` int(11) NOT NULL,
  `cod_puntoventa` int(11) DEFAULT NULL,
  `cod_personal` int(11) DEFAULT NULL,
...
INSERT INTO `estacionamientos` (`cod_estacionamiento`, `cod_puntoventa`, `cod_personal`, `cod_nivel`, `numeracion`, `estado`) VALUES
(1, 86, 1, 1, 1, 'Libre'),
(2, 86, 1, 1, 2, 'Libre'),
(3, 86, 1, 1, 3, 'Libre'),
(4, 86, 1, 1, 4, 'Libre'),
...
CREATE TABLE `factura` (
  ...
  `fecha_actualizacion` timestamp NULL DEFAULT NULL,
  `cod_personal` int(11) DEFAULT NULL,
  `codigo_compro` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `serie` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `num_comprobante` int(11) DEFAULT NULL,
  `fecha_registro` date DEFAULT NULL,
  `cod_tipodoc` int(11) DEFAULT NULL,
  `num_documento` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `direccion_empresa` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `email_cliente` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `doc_modificado` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cod_tipo_motivo` int(11) DEFAULT NULL,
  `cod_tipo_compro_modif` int(11) DEFAULT NULL,
...
INSERT INTO `nivel` (`cod_nivel`, `nivel`, `estado`) VALUES
(1, 'Primer Nivel', 'A'),
(2, 'Segundo Nivel', 'A'),
(3, 'Tercer Nivel', 'A');
...
CREATE TABLE `parkeo` (
  `cod_parkeo` int(11) NOT NULL,
  `cod_estacionamiento` int(11) DEFAULT NULL,
  `fecha_creacion` timestamp NULL DEFAULT NULL,
  `fecha_actualizacion` timestamp NULL DEFAULT NULL,
  `cod_puntoventa` int(11) DEFAULT NULL,
  `cod_personal` int(11) DEFAULT NULL,
  `num_placa` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `fecha_ingreso` date DEFAULT NULL,
  `hora_ingreso` time DEFAULT NULL,
  `fecha_salida` date DEFAULT NULL,
  `hora_salida` time DEFAULT NULL,
  `estado` char(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'ingreso/pago/salio/anulo'
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `personal` (
  ...
  `usuario` varchar(55) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `clave` varchar(55) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `personal` (`cod_personal`, `fecha_creacion`, `fecha_actualizacion`, `cod_puntoventa`, `nombres`, `apellidos`, `cod_tipodoc`, `num_documento`, `email`, `movil`, `cargo`, `fecha_ingreso`, `imagen`, `usuario`, `clave`, `accesos`, `estado`) VALUES
(1, '2023-04-13 05:04:00', '2023-05-25 04:55:47', 118, 'Luis Angel', 'Huallpa', 1, '46880885', 'angl01_92@hotmail.com', '958825129', 'Administrador', '2023-04-12', 'cv.png', '1a0a99cc5532e3e4ce72dd493354145b6e8d87e6', '93218b94428e93f0cdd3e13c2952606c89e0894e', NULL, 'A'),
(7, '2023-05-24 21:48:53', '2023-05-24 21:48:53', 118, 'Diego', 'Silvera', 1, '75438387', 'diego.silvera1998@gmail.com', '944417924', 'Administrador', '2023-05-22', 'Diego Silvera.jpg', '0fd200fa7c678f389f49c52654d59f0071f24c0d', '7c4a8d09ca3762af61e59520943dc26494f8941b', NULL, 'A'),
(10, '2023-05-25 04:32:13', '2023-06-01 03:19:00', 118, 'Josseline', 'Atalaya', 1, '78965412', 'josseline@gmail.com', '936937270', 'Contabilidad', '2023-05-22', 'Screenshot_20201008-151049_WhatsApp.jpg', 'facbe067b9d5854cf3648acdb009dad5885b19e8', '13c02ae279429edc4274cc76e3a4a7cbb01575d2', NULL, 'I');
...
CREATE TABLE `puntos_venta` (
  ...
  `fecha_actualizacion` timestamp NULL DEFAULT NULL,
  `cod_personal` int(11) DEFAULT NULL,
  `nombre_puntoventa` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `codigo_puntoventa` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `codigoUbigeo` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `codigoLocal` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `direccion` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `telefono` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `email` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `estado` char(1) COLLATE utf8mb4_unicode_ci DEFAULT NULL
...
INSERT INTO `puntos_venta` (`cod_puntoventa`, `fecha_creacion`, `fecha_actualizacion`, `cod_personal`, `nombre_puntoventa`, `codigo_puntoventa`, `alias`, `Departamento`, `Provincia`, `Distrito`, `codigoUbigeo`, `codigoLocal`, `direccion`, `telefono`, `email`, `estado`) VALUES
(118, '2023-05-22 22:28:01', '2023-05-25 04:54:39', 1, 'Sistemas', '118', 'Soporte', '15', '1501', '150130', '', '', 'Av. Primavera 609, Of. 205', '', 'sistemas@controlparking.com.pe', 'A'),
(2, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'Arequipa', '', 'Economax', '04', '0401', '040126', '', '', 'Av. Metropolitana 63', '', '', 'A'),
(3, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'Cusco', '', 'Economax', '08', '0801', '080104', '', '', 'Av. La Cultura', '', '', 'A'),
(4, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'Piura', '', 'Economax', '20', '2001', '200115', '', '', 'Av. Sánchez Cerro Sublote, Sánchez Cerro Lateral', '', '', 'A'),
(5, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'Zárate', '', 'Economax', '15', '1501', '150132', '', '', 'Parcelación Rustica, 23 Urb', '', '', 'A'),
(6, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'PV Alfonso Ugarte', '', 'Plaza Vea', '15', '1501', '150101', '', '', 'Av. Alfonso Ugarte 1145', '', '', 'A'),
(7, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'PV Acho', '', 'Plaza Vea', '15', '1501', '150128', '', '', 'Marañón 601', '', '', 'A'),
(8, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'PV Ate', '', 'Plaza Vea', '15', '1501', '150103', '', '', 'Av. Nicolas Ayllon Sector B. Mz B Lte.4 Zona A', '', '', 'A'),
(9, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'PV Ayacucho', '', 'Plaza Vea', '15', '1501', '150140', '', '', 'Av. Ayacucho 121', '', '', 'A'),
(10, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'PV Bolichera', '', 'Plaza Vea', '15', '1501', '150140', '', '', 'Av Tomás Marsano 5000', '', '', 'A'),
(11, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'PV Brasil', '', 'Plaza Vea', '15', '1501', '150113', '', '', 'Av. Brasil 1599', '', '', 'A'),
(12, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'PV Breña', '', 'Plaza Vea', '15', '1501', '150105', '', '', 'Juan Pablo Fernandini 754', '', '', 'A'),
(13, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'PV Callao', '', 'Plaza Vea', '07', '0701', '070102', '', '', 'Av. Óscar R. Benavides 4929', '', '', 'A'),
(14, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'PV Ceres', '', 'Plaza Vea', '15', '1501', '150103', '', '', 'Carr. Central 2', '', '', 'A'),
(15, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'PV Chacarilla', '', 'Plaza Vea', '15', '1501', '150140', '', '', 'Av. Caminos del Inca 351', '', '', 'A'),
(16, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'PV Chosica', '', 'Plaza Vea', '15', '1501', '150118', '', '', 'Av. Lima Sur 930-970', '', '', 'A'),
(17, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'PV Colonial', '', 'Plaza Vea', '07', '0701', '070102', '', '', 'Av Saenz Peña 1250', '', '', 'A'),
(18, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'PV Comas', '', 'Plaza Vea', '15', '1501', '150110', '', '', 'Av. Túpac Amaru 3860', '', '', 'A'),
(19, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'PV Córpac', '', 'Plaza Vea', '15', '1501', '150130', '', '', 'Calle Remington 151', '', '', 'A'),
(20, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'PV Dasso', '', 'Plaza Vea', '15', '1501', '150131', '', '', 'Av. Camino Real 1335', '', '', 'A'),
(21, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'PV El Agustino', '', 'Plaza Vea', '15', '1501', '150111', '', '', 'Av. José Carlos Mariátegui', '', '', 'A'),
(22, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'PV El Cortijo', '', 'Plaza Vea', '15', '1501', '150104', '', '', 'Av. República de Panamá 515', '', '', 'A'),
(23, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'PV Higuereta', '', 'Plaza Vea', '15', '1501', '150140', '', '', 'Av. Aviación 5051', '', '', 'A'),
(24, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'PV Izaguirre', '', 'Plaza Vea', '15', '1501', '150112', '', '', 'Av. Carlos Izaguirre 284', '', '', 'A'),
(25, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'PV Kio', '', 'Plaza Vea', '15', '1501', '150123', '', '', 'Grifo KIO, Ctra. Panamericana S Km. 25', '', '', 'A'),
(26, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'PV La Paz', '', 'Plaza Vea', '15', '1501', '150136', '', '', 'Av. La Paz 2561', '', '', 'A'),
(27, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'PV La Placita', '', 'Plaza Vea', '15', '1501', '150142', '', '', 'Av. Juan Velasco Alvarado', '', '', 'A'),
(28, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'PV Los Olivos', '', 'Plaza Vea', '15', '1501', '150117', '', '', 'Av. Antúnez de Mayolo Cdra 9', '', '', 'A'),
(29, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'PV Mercaderes', '', 'Plaza Vea', '15', '1501', '150140', '', '', 'Av. Benavides cdra 51 s/n.', '', '', 'A'),
(30, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'PV Milenia', '', 'Plaza Vea', '15', '1501', '150131', '', '', 'Av. Paseo de la Republica 3440', '', '', 'A'),
(31, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'PV Miraflores', '', 'Plaza Vea', '15', '1501', '150122', '', '', 'Av. Arequipa 4651', '', '', 'A'),
(32, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'PV Primavera', '', 'Plaza Vea', '15', '1501', '150130', '', '', 'Av. Angamos Este 2337', '', '', 'A'),
(33, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'PV Puente Piedra', '', 'Plaza Vea', '15', '1501', '150125', '', '', 'Av. San Lorenzo Mz. A, Lt 01 Urb. Las Vegas', '', '', 'A'),
(34, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'PV SJL', '', 'Plaza Vea', '15', '1501', '150132', '', '', 'Urb. Quinta San Fernando S/N Unidad 44 C', '', '', 'A'),
(35, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'PV Sucre', '', 'Plaza Vea', '15', '1501', '150121', '', '', 'Av. Sucre cdra. 5 con Av. Clement', '', '', 'A'),
(36, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'PV Universitaria', '', 'Plaza Vea', '15', '1501', '150117', '', '', 'Av. Universitaria Cdra. 13', '', '', 'A'),
(37, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'PV Ventanilla', '', 'Plaza Vea', '07', '0701', '070106', '', '', 'Carretera Nestor Gambetta c / Av Pedro Beltran', '', '', 'A'),
(38, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'PV Lurín', '', 'Plaza Vea', '15', '1501', '150119', '', '', 'Urb. San Vicente S/N. Calle Antigua Panamericana Sur Parcela B-43', '', '', 'A'),
(39, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'PV Valle Hermoso', '', 'Plaza Vea', '15', '1501', '150140', '', '', 'Av. Jacarandá 890 Urb. Valle Hermoso', '', '', 'A'),
(40, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'PV San Jorge', '', 'Plaza Vea', '15', '1501', '150114', '', '', 'Av. La Molina 1080', '', '', 'A'),
(41, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'PV Chaclacayo', '', 'Plaza Vea', '15', '1501', '150107', '', '', ' Avenida Nicolás de Ayllón 582-598', '', '', 'A'),
(42, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'PV Arequipa', '', 'Plaza Vea', '04', '0401', '040101', '', '', 'Av. La Marina 300', '', '', 'A'),
(43, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'PV Chacarero', '', 'Plaza Vea', '13', '1301', '130101', '', '', 'Av. Prolongación Unión 2218 - Cruce con Av. Pesqueda', '', '', 'A'),
(44, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'PV Chimbote', '', 'Plaza Vea', '02', '0218', '021801', '', '', 'Esq. Av. Francisco Bolognesi con Jr. Tumbes s/n', '', '', 'A'),
(45, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'PV Chincha', '', 'Plaza Vea', '11', '1102', '110201', '', '', 'Calle Oscar R Benavides s/n', '', '', 'A'),
(46, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'PV Ica', '', 'Plaza Vea', '11', '1101', '110101', '', '', 'Calle Ayabaca Nº 1180', '', '', 'A'),
(47, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'PV Ilo', '', 'Plaza Vea', '18', '1803', '180301', '', '', 'Av. La Costanera 12, Ilo 18601', '', '', 'A'),
(48, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'PV Moquegua', '', 'Plaza Vea', '18', '1801', '180101', '', '', 'Los Chirimoyos, Moquegua 18001', '', '', 'A'),
(49, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'PV Paita', '', 'Plaza Vea', '20', '2005', '200501', '', '', 'Pasaje Vista Alegre Mz. L -10 carretera los Ejidos Km 1.2', '', '', 'A'),
(50, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'PV Puno', '', 'Plaza Vea', '21', '2101', '210101', '', '', 'Jr. Los Incas s/n Estación Ferroviaria', '', '', 'A'),
(51, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'PV Tacna', '', 'Plaza Vea', '23', '2301', '230101', '', '', 'Parcela 9 S/N Sector Pago Silpay', '', '', 'A'),
(52, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'PV Talara', '', 'Plaza Vea', '20', '2007', '200701', '', '', 'Av. Ignacio Merino', '', '', 'A'),
(53, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'PV Tumbes', '', 'Plaza Vea', '24', '2401', '240101', '', '', 'Teniente Vasquez 6851, Tumbes 24002', '', '', 'A'),
(54, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'PV Tambo', '', 'Plaza Vea', '12', '1201', '120114', '', '', 'Calle Real MzL Lt13 Urb. San Antonio de Padua', '', '', 'A'),
(55, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'PV Tarapoto', '', 'Plaza Vea', '22', '2201', '220101', '', '', 'Av. Salaverry 888 - Tarapoto', '', '', 'A'),
(56, '0000-00-00 00:00:00', '2023-05-12 20:10:28', 0, 'PV Sullana', '56', 'Plaza Vea', '20', '2006', '200601', '', '', 'Calle La Mar N°154', '', '', 'A'),
(57, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'Mega Plaza Chorrillos', '', 'Megaplaza', '15', '1501', '150108', '', '', 'Av Alameda Sur 5, Chorrillos 15067', '', '', 'A'),
(58, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'Mega Plaza VES 1', '', 'Megaplaza', '15', '1501', '150142', '', '', 'Av. Lima 2500', '', '', 'A'),
(59, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'Mega Plaza VES 2', '', 'Megaplaza', '15', '1501', '150142', '', '', 'Av. 1ro de Mayo, Villa EL Salvador 15842', '', '', 'A'),
(60, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'Mega Plaza Chincha', '', 'Megaplaza', '11', '1102', '110201', '', '', 'Panamericana Sur KM 197, Chincha', '', '', 'A'),
(61, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'Mega Plaza Cañete', '', 'Megaplaza', '15', '1505', '150501', '', '', 'Ica', '', '', 'A'),
(62, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'Mega Plaza Pisco', '', 'Megaplaza', '11', '1105', '110501', '', '', 'Av. Fermin Tanguis esquina con Av. Las Américas', '', '', 'A'),
(63, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'Mega Plaza Barranca', '', 'Megaplaza', '15', '1502', '150201', '', '', 'Jr. Zavala s/n cruce con Av. Castilla', '', '', 'A'),
(64, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'Mega Plaza Huaral', '', 'Megaplaza', '15', '1506', '150601', '', '', 'Carr. Huaral - Chancay 71', '', '', 'A'),
(65, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'Mega Plaza Chimbote', '', 'Megaplaza', '02', '0218', '021801', '', '', 'Av. Victor Raúl Haya de la Torre 4694', '', '', 'A'),
(66, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'Mega Plaza Jaén', '', 'Megaplaza', '06', '0608', '060801', '', '', 'Av. Manuel Antonio Mesones Muro, Jaén 06801', '', '', 'A'),
(67, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'Parque Lambramani', '', 'Parque Arauco', '04', '0401', '040101', '', '', 'Av. Lambramani 325, Arequipa', '', '', 'A'),
(68, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'Parque Jaen', '', 'Parque Arauco', '', '', '', '', '', '', '', '', 'A'),
(69, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'Tottus Zorrito', '', 'Precio Uno', '', '', '', '', '', '', '', '', 'A'),
(70, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'HB Precio Uno - Dueñas', '', 'Precio Uno', '15', '1501', '150101', '', '', 'Av. Nicolás Dueñas N° 475, Lima 15079', '', '', 'A'),
(71, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'HB Precio Uno - La Tinguiña', '', 'Precio Uno', '', '', '', '', '', '', '', '', 'A'),
(72, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'HB Precio Uno - Moyobamba', '', 'Precio Uno', '', '', '', '', '', '', '', '', 'A'),
(73, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'HB Precio Uno - Ferreñafe', '', 'Precio Uno', '', '', '', '', '', '', '', '', 'A'),
(74, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'Real Plaza Sullana', '', 'Real Plaza', '', '', '', '', '', '', '', '', 'A'),
(75, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'Real Plaza Piura', '', 'Real Plaza', '', '', '', '', '', '', '', '', 'A'),
(76, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'Real Plaza Trujillo', '', 'Real Plaza', '', '', '', '', '', '', '', '', 'A'),
(77, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'Real Plaza Cajamarca', '', 'Real Plaza', '', '', '', '', '', '', '', '', 'A'),
(78, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'Real Plaza Chiclayo', '', 'Real Plaza', '', '', '', '', '', '', '', '', 'A'),
(79, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'Real Plaza Chimbote', '', 'Real Plaza', '', '', '', '', '', '', '', '', 'A'),
(80, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'Real Plaza Huánuco', '', 'Real Plaza', '', '', '', '', '', '', '', '', 'A'),
(81, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'Real Plaza Huancayo', '', 'Real Plaza', '', '', '', '', '', '', '', '', 'A'),
(82, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'Real Plaza Pucallpa', '', 'Real Plaza', '', '', '', '', '', '', '', '', 'A'),
(83, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'Real Plaza Juliaca', '', 'Real Plaza', '', '', '', '', '', '', '', '', 'A'),
(84, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'Real Plaza Cusco', '', 'Real Plaza', '', '', '', '', '', '', '', '', 'A'),
(85, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'Real Plaza Arequipa', '', 'Real Plaza', '', '', '', '', '', '', '', '', 'A'),
(86, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'Real Plaza Centro Cívico', '', 'Real Plaza', '15', '', '', '', '', '', '', '', 'A'),
(87, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'Real Plaza Guardia Civil', '', 'Real Plaza', '', '', '', '', '', '', '', '', 'A'),
(88, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'Real Plaza La Curva - VMT', '', 'Real Plaza', '15', '', '', '', '', '', '', '', 'A'),
(89, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'Real Plaza Primavera', '', 'Real Plaza', '15', '', '', '', '', '', '', '', 'A'),
(90, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'Real Plaza Pro', '', 'Real Plaza', '15', '', '', '', '', '', '', '', 'A'),
(91, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'Real Plaza Salaverry', '', 'Real Plaza', '15', '', '', '', '', '', '', '', 'A'),
(92, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'Real Plaza Santa Clara', '', 'Real Plaza', '', '', '', '', '', '', '', '', 'A'),
(93, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'Real Plaza Puruchuco', '', 'Real Plaza', '15', '', '', '', '', '', '', '', 'A'),
(94, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'Mall Aventura Santa Anita', '', 'Mall Aventura Plaza', '15', '', '', '', '', '', '', '', 'A'),
(95, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'Mall Plaza Cayma', '', 'Mall Aventura Plaza', '', '', '', '', '', '', '', '', 'A'),
(96, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'Mall Aventura Arequipa', '', 'Mall Aventura Plaza', '', '', '', '', '', '', '', '', 'A'),
(97, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'Mall Aventura Chiclayo', '', 'Mall Aventura Plaza', '', '', '', '', '', '', '', '', 'A'),
(98, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'Santa Cruz', '', 'Operaciones Control Parking', '', '', '', '', '', '', '', '', 'A'),
(99, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'Alcázar', '', 'Operaciones Control Parking', '', '', '', '', '', '', '', '', 'A'),
(100, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'Guardia Civil', '', 'Operaciones Control Parking', '', '', '', '', '', '', '', '', 'A'),
(101, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'Polvos Rosados', '', 'Operaciones Control Parking', '', '', '', '', '', '', '', '', 'A'),
(102, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'Camino Real', '', 'Operaciones Control Parking', '', '', '', '', '', '', '', '', 'A'),
(103, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'El Reloj', '', 'Operaciones Control Parking', '', '', '', '', '', '', '', '', 'A'),
(104, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'Hotel Hampton', '', 'Operaciones Control Parking', '', '', '', '', '', '', '', '', 'A'),
(105, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'Molina Plaza', '', 'Operaciones Control Parking', '', '', '', '', '', '', '', '', 'A'),
(106, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'Notaria Paino', '', 'Operaciones Control Parking', '', '', '', '', '', '', '', '', 'A'),
(107, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'Bordemar', '', 'Operaciones Control Parking', '', '', '', '', '', '', '', '', 'A'),
(109, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'Saga Falabella', '', 'Operaciones Control Parking', '', '', '', '', '', '', '', '', 'A'),
(110, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'Centro Empresarial Santa María', '', 'Operaciones Control Parking', '', '', '', '', '', '', '', '', 'A'),
(111, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'Centro Aéreo Comercial', '', 'Operaciones Control Parking', '', '', '', '', '', '', '', '', 'A'),
(112, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'Vivanda 2 de Mayo', '', 'Vivanda', '', '', '', '', '', '', '', '', 'A'),
(113, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'Vivanda Asia', '', 'Vivanda', '', '', '', '', '', '', '', '', 'A'),
(114, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'Vivanda Benavides', '', 'Vivanda', '', '', '', '', '', '', '', '', 'A'),
(115, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'Vivanda Libertadores', '', 'Vivanda', '', '', '', '', '', '', '', '', 'A'),
(116, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'Vivanda Pardo', '', 'Vivanda', '', '', '', '', '', '', '', '', 'A'),
(117, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'Vivanda Pezet', '', 'Vivanda', '', '', '', '', '', '', '', '', 'A');
...
INSERT INTO `servicios` (`cod_servicio`, `fecha_creacion`, `fecha_actualizacion`, `cod_personal`, `nombre_servicio`, `descripcion`, `costo`, `estado`) VALUES
(1, '2023-06-01 04:34:14', '2023-06-01 04:50:41', 1, 'HORA/FRACCIÓN S/5.00', 'VEHÍCULOS LIGEROS HORA/FRACCIÓN', 5, 'A'),
(2, '2023-06-01 04:35:13', '2023-06-01 04:35:13', 1, 'HORA/FRACCIÓN S/10.00', 'VEHÍCULOS PESADOS HORA/FRACCIÓN', 10, 'A');
...
CREATE TABLE `sub_modulos` (
  `cod_submodulos` int(11) NOT NULL,
  `cod_personal` int(11) DEFAULT NULL,
  `cod_modulo` int(11) DEFAULT NULL,
...
CREATE TABLE `ubigeo_distritos` (
  ...
  `province_id` varchar(4) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `department_id` varchar(2) COLLATE utf8mb4_unicode_ci DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
ALTER TABLE `apertura_cajas`
  ADD PRIMARY KEY (`cod_aperturacaja`);
...
ALTER TABLE `sub_modulos`
  ADD PRIMARY KEY (`cod_submodulos`);
...
--
ALTER TABLE `apertura_cajas`
  MODIFY `cod_aperturacaja` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `estacionamientos`
  MODIFY `cod_estacionamiento` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `parkeo`
  MODIFY `cod_parkeo` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `personal`
--
ALTER TABLE `personal`
  MODIFY `cod_personal` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT de la tabla `puntos_venta`
--
ALTER TABLE `puntos_venta`
  MODIFY `cod_puntoventa` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=119;

--
-- AUTO_INCREMENT de la tabla `serie_documentos`
--
ALTER TABLE `serie_documentos`
  MODIFY `cod_serie` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `servicios`
--
ALTER TABLE `servicios`
  MODIFY `cod_servicio` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de la tabla `sub_modulos`
--
ALTER TABLE `sub_modulos`
  MODIFY `cod_submodulos` int(11) NOT NULL AUTO_INCREMENT;
